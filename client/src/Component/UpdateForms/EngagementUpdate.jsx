...
const StudentActivities = () => {
  ...
  const handleFetch = async () => {
    ...
    // fetch(`/api/activities?email=${activities.email}`)
    ...
    setActivities({teacherInteraction:response.data.resp.engagement.ti,groupDiscussion:response.data.resp.engagement.gd,studentInteraction:response.data.resp.engagement.si});
  };
